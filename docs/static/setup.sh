...
options=("Kyria" "Lily58" "Corne" "Splitreus62" "Sofle" "Iris" "Reviung41" "RoMac" "RoMac+" "makerdiary M60" "Microdox" "TG4X" "QAZ" "Jorne" "Jian" "CRBN" "Tidbit" "Helix")
...
select opt in "${options[@]}" "Quit"; do
    ...
    19 ) shield_title="Helix" shield="helix"; split="y"; break;;
